...
---
<!-- cycle:rendered template=skills/deploy-prod.md.tmpl hash=104ae4281571 — managed by the-cycle; edit the template, not this file -->

# /deploy-prod — ship to production

Goal: make the safe path automatic — **not** the decision to ship.

**Shared rules in `.opencode/skills/DOCTRINE.md` — read it if not already in context.** This is the
