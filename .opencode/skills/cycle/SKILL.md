...
---
<!-- cycle:rendered template=skills/cycle.md.tmpl hash=99419489f5e9 — managed by the-cycle; edit the template, not this file -->
...
**Before the `/done` phase, ensure `.opencode/skills/DELIVERY.md` is in context; read it only if
