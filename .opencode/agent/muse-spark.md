---
description: Fast, cheap implementer subagent pinned to muse-spark-1.2-contributor. Use for well-scoped mechanical implementation tasks where the orchestrator reviews the diff and gates afterward.
mode: subagent
